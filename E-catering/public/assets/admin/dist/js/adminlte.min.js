 ...
 */
! function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).merchantlte = {}, e.jQuery)
}(this, (function (e, t) {
    "use strict";
        ...
        Qe = function () {
            ...
            return t.onTabClick = function (e) {
                ...
                if (n.default(ue).length > 0) {
                    ...
                    localStorage.setItem("merchantLTE:IFrame:Options", JSON.stringify(i));
                ...
                } else new e(n.default(this), JSON.parse(localStorage.getItem("merchantLTE:IFrame:Options")))._initFrameElement()
            }, e
        }();
...
//# sourceMappingURL=merchantlte.min.js.map
